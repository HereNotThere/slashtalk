...
/** GitHub-style PR branch glyph. Filled with `currentColor`; tint via the
 *  className's text-color (e.g. `text-success` for open). */
export function PrIcon({ className }: { className?: string }): JSX.Element {
  return (
    <svg
      width="12"
      height="12"
