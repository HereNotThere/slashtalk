/**
 * Brand marks and domain glyphs that aren't in Heroicons. For everything else,
...
/** Git branch glyph — Heroicons has no equivalent. */
export function BranchIcon(): JSX.Element {
  return (
    <svg width="10" height="10" viewBox="0 0 16 16" fill="none" aria-hidden>
      ...
      <path
        d="M4 4.6 V11.4 M4 8 Q4 6 6 6 H10.4"
        stroke="currentColor"
        strokeWidth="1.2"
        strokeLinecap="round"
        fill="none"
...
/** Spotify mark — keeps real brand green (not our `success` token). */
...
/** State-specific PR glyphs from GitHub's Octicons (MIT). The shape carries
 *  meaning beyond color: open = git-pull-request, merged = git-merge,
 *  closed = git-pull-request-closed. Filled with `currentColor`; tint via
 *  the className (e.g. `text-merged`). */
