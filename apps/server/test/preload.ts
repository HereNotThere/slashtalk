...
process.env.GITHUB_APP_CLIENT_ID =
  process.env.GITHUB_APP_CLIENT_ID || "test_app_client_id";
...
process.env.GITHUB_APP_SLUG =
  process.env.GITHUB_APP_SLUG || "slashtalk-dev-repo-access";
process.env.JWT_SECRET =
  process.env.JWT_SECRET || "test_jwt_secret_for_ci_that_is_long_enough";
