...
| **Design doc** | `docs/design-docs/<topic>.md` | Topic-level durable decision (one decision = one doc). Captures *why*, alternatives rejected, how to apply. | Template: [`templates/design-doc.md`](templates/design-doc.md) | When a non-trivial decision is made that future work must respect |
